...
<template>
    <div class="flex flex-col items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" class="w-[400px]">
            <g id="freepik--background-complete--inject-49">
                ...
                <path d="M383.88,100.52a3.34,3.34,0,1,0-4.73-4.73l3.57-5.36,4.78,2.42,1.05,5Z" style="fill:#e0e0e0">
                </path>
                <path
                ...
                <polygon
                    ...
                    style="fill:#e0e0e0"></polygon>
                <path d="M90,294.13a1.8,1.8,0,0,1,2.54-2.54l-1.91-2.87L88,290l-.56,2.7Z" style="fill:#e0e0e0"></path>
                <path
                ...
                <path
                    ...
                    style="fill:#f0f0f0"></path>
                <path d="M74.11,77.71a4.45,4.45,0,1,1-3,5.78A4.59,4.59,0,0,1,74.11,77.71Z" style="fill:#e0e0e0"></path>
                <rect x="74.93" y="76.84" width="1.37" height="10.1" transform="translate(24.11 180.74) rotate(-109.76)"
            ...
            <g id="freepik--error-404--inject-49">
                <path
                ...
                <path
                    ...
                    style="fill:#263238"></path>
                <path d="M409.08,197.24a85.06,85.06,0,0,0-3,9.36c-.75,3.53-.79,11.43-.79,11.43" style="fill:#263238">
                </path>
                <path
            ...
            <g id="freepik--robot-parts--inject-49">
                <path
                ...
                <path d="M226.16,421.73a2.45,2.45,0,1,1,0-4.89l-4.6-.92-1.23,3.72,2.06,3.14Z" style="fill:#263238">
                </path>
                <path
                ...
                <polygon
                    ...
                    style="fill:#407BFF"></polygon>
                <path d="M419.9,412.59a1.82,1.82,0,1,0,0-3.63l3.42-.68.91,2.76-1.52,2.33Z" style="fill:#407BFF"></path>
                <path
                ...
                <path
                    ...
                    style="fill:#263238"></path>
                <path d="M335.73,414.86a4.46,4.46,0,1,1,2,6.18A4.61,4.61,0,0,1,335.73,414.86Z" style="fill:#407BFF">
                </path>
                <rect x="339.07" y="411.71" width="1.37" height="10.1"
                    transform="translate(469.33 938.61) rotate(-154.76)" style="fill:#263238"></rect>
            </g>
        </svg>
        <span class="font-bold text-3xl uppercase text-muted-foreground">Edukasi tidak ditemukan</span>
    </div>
</template>
