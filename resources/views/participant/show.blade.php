<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ $participant->name ?? __('Detail') . ' ' . __('Participant') }}
        </h2>
    </x-slot>
                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Detail') }} Participant
                            </h1>
                            <p class="mt-2 text-sm text-gray-700">Rincian dari {{ __('Participant') }}.</p>
                        </div>
